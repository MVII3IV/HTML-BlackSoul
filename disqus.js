var DISQUS = function (a) {
    ...
    return b.define = function (c, d) {
        ...
        for (var i in h) h.hasOwnProperty(i) && (!h.__overwrites__ && null !== g[i] && g.hasOwnProperty(i) ? b.log && b.log("Unsafe attempt to redefine existing module: " + i) : g[i] = h[i]);
        return g
    }, b.use = function (a) {
        return b.define(a)
    }, b.define("next"), b
...
DISQUS.define(function (a, b) {
        ...
        "use strict";
        var b;
        return b = a.console ? a.console.log.apply ? function () {
        ...
        var j = h.WindowBase = function (a) {
            a = a || {}, this.state = j.INIT, this.uid = a.uid || DISQUS.getUid(), this.origin = a.origin, this.host = h.getHost(this.origin), this.target = a.target, this.window = null, d[this.uid] = this, this.on("ready", function () {
                this.state = j.READY
        ...
        }), DISQUS.extend(j.prototype, DISQUS.Events), j.prototype.sendMessage = function (a, b) {
            var c = e.stringify({
                    scope: "client",
                    name: a,
                    data: b
                ...
                d = function (a, b) {
                    return function () {
                        var c = a.window;
                        c ? j.postMessage(c, b, a.origin) : setTimeout(d, 500)
                    }
                }(this, c);
        ...
        var k = h.Popup = function (a) {
            j.call(this, a), this.windowName = a.windowName
        };
        ...
        DISQUS.extend(l.prototype, j.prototype), l.prototype.load = function () {
            ...
            a.setAttribute("id", "dsq-" + this.uid), a.setAttribute("data-disqus-uid", this.uid), a.setAttribute("allowTransparency", "true"), a.setAttribute("frameBorder", "0"), a.setAttribute("scrolling", "no"), this.role && a.setAttribute("role", this.role), a.setAttribute("tabindex", this.tabIndex), a.setAttribute("title", this.title), this.setInlineStyle(this.styles)
        ...
        DISQUS.extend(m.prototype, l.prototype), m.prototype.load = function (a) {
            ...
            var e = DISQUS.isString(this.container) ? b(this.container) : this.container;
            e.appendChild(d)
        ...
        function g() {
            for (var a = t.getElementsByTagName("h1"), c = t.title, d = c.length, e = c, g = .6, h = 0; h < a.length; h++) ! function (a) {
        ...
        function h(a, b, c) {
            if (c = c || b, a === t) return "";
            var d = r(a, b, c);
            return "transparent" === d || "" === d || "rgba(0, 0, 0, 0)" === d ? h(a.parentNode, b, c) : d || null
        }
        ...
        function l(a, b, c, d) {
            DISQUS.isString(b) && (b = t.createElement(b));
            var e = null;
        ...
        function q(a) {
            (new Image).src = DISQUS.serialize(s + "/stat.gif", {
                event: a
            })
        }

        function r(b, c, d) {
            return a.getComputedStyle ? t.defaultView.getComputedStyle(b, null).getPropertyValue(c) : b.currentStyle ? b.currentStyle[c] ? b.currentStyle[c] : b.currentStyle[d] : void 0
        }
        var s = "https://referrer.disqus.com/juggler",
            t = a.document,
            u = function () {
                var a, b, c = function () {
                    return !1
                };
                if ("undefined" != typeof t.hidden) a = "hidden", b = "visibilitychange";
                else if ("undefined" != typeof t.mozHidden) a = "mozHidden", b = "mozvisibilitychange";
                else if ("undefined" != typeof t.msHidden) a = "msHidden", b = "msvisibilitychange";
                else {
                    if ("undefined" == typeof t.webkitHidden) return {
                        isHidden: c,
                        listen: c,
                        stopListening: c
                    };
                ...
                return {
                    ...
                    listen: function (a) {
                        return DISQUS.addEvent(t, b, a)
                    },
                    stopListening: function (a) {
                        return DISQUS.removeEvent(t, b, a)
                    }
                }
            }(),
            v = function () {
                var a = t.createElement("div");
                a.style.visibility = "hidden", a.style.width = "100px", a.style.msOverflowStyle = "scrollbar", t.body.appendChild(a);
                var b = a.offsetWidth;
            ...
            x = {
                ...
                isSafari: function () {
                    ...
                    return a.indexOf("safari") > -1 && -1 === a.indexOf("chrome")
                }
            },
            y = {
                getItem: function (c) {
        ...
        var b = DISQUS.next.host,
            ...
            e = d.extend({
                name: "onboard",
                loaderVersion: c.getLoaderVersionFromUrl("//a.disquscdn.com/next/embed/onboard.load.ecfc23483a22926d5b596db2612d982e.js"),
                events: {
                ...
                getUrl: function () {
                    var a = this.settings;
                    return d.prototype.getUrl.call(this, {
                        f: a.forum,
                        l: a.language
                    })
                },
                getFrameSettings: function (a) {
                    return a.role = "dialog", a.styles = {
                        height: "100%",
                        position: "fixed",
                        top: 0,
                        left: 0,
        ...
        var b = a.document,
            ...
            f = e.extend({
                name: "lounge",
                loaderVersion: d.getLoaderVersionFromUrl("//a.disquscdn.com/next/embed/lounge.load.dc0f943decaa45b7b10b593fc59c3c57.js"),
                indicators: null,
                wasInViewport: !1,
                ...
                showOnboard: function (a) {
                    ...
                    this.stopListening(d), this.listenToOnce(d, "onboard.complete", function () {
                        this.frame.sendMessage("onboard.complete")
                    }), this.listenTo(d, "onboard.profileUpdated", function () {
                ...
                addLoadingAnim: function () {
                    ...
                    if (!(f.state >= f.constructor.states.RUNNING)) {
                        ...
                        h.rel = "stylesheet", h.href = "//a.disquscdn.com/next/embed/styles/loading.aaa873ed4a78106f29994d34d7eabec1.css", (b.head || b.getElementsByTagName("head")[0]).appendChild(h), a = b.createElement("div"), c = b.createElement("div"), e = b.createElement("div"), c.appendChild(e), a.appendChild(c), a.dir = "ltr", a.style.overflow = "hidden";
                ...
                destroy: function () {
                    ...
                    this.removeLoadingAnim(), a && a.north && (a.north.destroy(), a.north = null), a && a.south && (a.south.destroy(), a.south = null), e.prototype.destroy.call(this)
                }
            }, {
        ...
        return c.app.expose(f, ["list", "listByKey", "get"], g), {
            Lounge: g
        }
